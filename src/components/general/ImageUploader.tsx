...
export default function ImageUploader({ handleUpload, isLoading }: ImageUploaderProps) {
                    ...
                    <Box position="relative" height="100%" width="100%">
                        ...
                        >
                            <Stack
                                ...
                                spacing="4"
                            >
                                <Box height="12" width="12" position="relative">
                                </Box>
                                {isLoading ?
                                    (
                                        ...
                                        <div className="flex flex-col items-center m-auto">
                                            <IoCloudUploadOutline size={50} className='animate-bounce' />
