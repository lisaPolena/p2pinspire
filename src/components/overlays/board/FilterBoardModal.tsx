...
const FilterBoardModal: React.FC = () => {
  ...
  return (
    <Modal
      modalId="filter-board-modal"
      isOpen={filterBoardModalOpen}
      closeModal={() => setFilterBoardModalOpen(false)}
      title="Set view as"
      height="h-[30%]"
    >
      <List>
        <ListItem
          ...
          onClick={() => handleSetBoardView("wide")}
        >
        ...
        <ListItem
          className="flex flex-row justify-between"
          onClick={() => handleSetBoardView("default")}
        >
        ...
        <ListItem
          className="flex flex-row justify-between"
          onClick={() => handleSetBoardView("compact")}
        >
